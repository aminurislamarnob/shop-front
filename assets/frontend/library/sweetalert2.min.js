...
! ( function ( e, t ) {
		...
		re = ( e ) => {
			...
			const i = ( ( e ) => {
				if ( 'string' == typeof e ) {
					...
					if ( ! t )
						throw new Error( `Target element "${ e }" not found` );
					return t;
				}
				return e;
			} )( e.target || 'body' );
			i.appendChild( n ),
				e.topLayer &&
					( n.setAttribute( 'popover', '' ), n.showPopover() ),
				( ( e ) => {
					const t = C();
					t &&
						( t.setAttribute(
	...
	const ge = [
		...
		fe = ( e ) => {
			...
			if ( ! Ee[ e.input ] )
				return void d(
					`Unexpected type of input! Expected ${ Object.keys(
						Ee
					).join( ' | ' ) }, got "${ e.input }"`
				);
			const t = Ce( e.input );
	...
	( Ee.text =
		...
		( Ee.textarea = ( e, t ) => {
			const n = e;
			Ae( n, t.inputValue ), ve( n, t ), we( n, n, t );
			return (
				setTimeout( () => {
	...
	const He = ( e ) => {
		...
		Ie = ( e ) => {
			const t = C();
			if ( t && Te ) {
				let { clientX: n, clientY: i } = Ve( e );
				const s = n - Se;
				( t.style.insetInlineStart = `${
					Me + ( o.isRTL ? -s : s )
				}px` ),
					( t.style.insetBlockStart = `${ je + ( i - Oe ) }px` );
			}
		},
		De = () => {
			const e = C();
	...
	function jt() {
		...
		const n = he.focusedElement.get( this );
		n instanceof HTMLElement &&
			( n.focus(), he.focusedElement.delete( this ) );
	}
	const Ht = ( e ) => {
	...
	function It() {
		...
		return t ? R( t.popup, e.input ) : null;
	}
	function Dt( e, t, n ) {
	...
	function qt() {
		...
		e instanceof HTMLElement &&
			( e.focus(), he.focusedElement.delete( this ) );
	}
	function Nt() {
	...
	const mn = ( e ) => {
		...
		fn = ( e ) =>
			...
			( ( e ) => 'object' == typeof e && null !== e && 'jquery' in e )(
				e
			);
	const bn = () => {
			if ( o.timeout )
	...
	class Un {
		...
		_main( e, t = {} ) {
			...
			const i = Kn( Rn );
			return Fe( Rn, n ), he.innerParams.set( Rn, n ), zn( Rn, i, n );
		}
		then( e ) {
	...
	const zn = ( e, t, n ) =>
		...
		Zn = ( e ) => {
			...
			for ( const e of t )
				if ( e instanceof HTMLElement && ee( e ) )
					return e.focus(), ! 0;
			return ! 1;
		},
		Jn = ( e, t ) =>
