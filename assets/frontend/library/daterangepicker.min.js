...
! ( function ( t, e ) {
	...
	var a = function ( a, i, s ) {
		...
		if (
			...
			'object' == typeof i.startDate &&
				( this.startDate = t( i.startDate ) ),
			...
			for ( l in i.ranges ) {
				...
				if (
					...
					! (
						...
						( m &&
							o.isAfter( m, this.timepicker ? 'minute' : 'day' ) )
					) )
				) {
					var p;
		...
		'function' == typeof s && ( this.callback = s ),
			...
			this.element.is( 'input' ) || this.element.is( 'button' )
				? this.element.on( {
						...
						'keydown.daterangepicker': e.proxy(
							this.keydown,
							this
						),
				  } )
				...
				if ( this.element.is( 'input' ) && this.element.val().length ) {
					...
					2 === e.length &&
						...
						( this.singleDatePicker || null === a || null === i ) &&
							( i = a =
								t( this.element.val(), this.locale.format ) ),
						a.isValid() &&
							i.isValid() &&
							( this.setStartDate( a ),
							this.setEndDate( i ),
