( function ( $ ) {
	...
	var StoreFrontFormHandler = {
		...
		appendTermRow: function ( data ) {
			...
			// Mirrors templates/shared/list-bulk-checkbox.php — keep both in sync.
			var checkboxCell =
				'<td class="check-column">' +
					'<label class="my-storesuite-checkbox">' +
						'<input type="checkbox" class="my-storesuite-checkbox-input storesuite-bulk-cb" aria-label="' + $( '<span>' ).text( i18n.select_item_label || '' ).html() + '" value="' + data.term_id + '">' +
