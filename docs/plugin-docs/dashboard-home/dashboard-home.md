...
![StoreSuite Dashboard overview](screenshots/screenshot-1.png)
...
![Date range picker](screenshots/screenshot-2.png)
...
![Recent orders and quick actions](screenshots/screenshot-3.png)
