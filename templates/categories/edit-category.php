						...
						<div x-data="categoryEditFormHandler(<?php echo esc_attr( $category->term_id ); ?>)">
							<form id="msfc-edit-category" @submit.prevent="handleCategoryEditSubmission">
								<div class="msf-form-group">
									...
									<input type="text" class="msf-form-control" id="product_category_name" name="product_category_name" placeholder="<?php echo esc_attr__( 'Product category name', 'shop-front' ); ?>" value="<?php echo esc_attr( $category->name ); ?>" aria-required="true">
								</div>
								<div class="msf-form-group">
								...
								<div class="msf-form-submission-group">
									...
									<div class="msf-button-group">
										...
										<a href="<?php echo esc_url( msfc_get_navigation_url( 'categories' ) ); ?>" class="my-shop-front-button my-shop-front-button-light">Back</a>
									</div>
								</div>
							</form>
