<?php
/**
 * Category quick edit fields (loaded into the shared quick edit modal via AJAX).
 *
 * @package StoreSuite
 *
 * @var string   $object_type Object type ("category").
 * @var string   $taxonomy    Taxonomy ("product_cat").
 * @var \WP_Term $term        Category term.
 */
