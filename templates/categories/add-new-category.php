						...
						<div x-data="categoryAddFormHandler()">
							<form id="msfc-add-category" @submit.prevent="handleCategorySubmission">
								<div class="msf-form-group">
									...
									<input type="text" class="msf-form-control" id="product_category_name" name="product_category_name" placeholder="<?php echo esc_attr__( 'Product category name', 'shop-front' ); ?>" aria-required="true">
								</div>
								<div class="msf-form-group">
