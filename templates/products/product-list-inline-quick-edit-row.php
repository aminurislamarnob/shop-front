<?php
/**
 * Inline quick edit row — field set aligned with common marketplace vendor inline editors
 * (title, categories, tags, reviews, status, product data, stock).
 *
 * @package StoreSuite
 *
...
?>
<tr class="storesuite-product-list-inline-edit-form storesuite-hide" id="storesuite-inline-edit-<?php echo esc_attr( (string) $product_id ); ?>">
	<td colspan="10">
		<fieldset class="storesuite-product-inline-edit-fieldset">
			<div class="storesuite-inline-edit-grid">
				<div class="storesuite-inline-edit-column">
					<strong class="storesuite-inline-edit-section-title"><?php esc_html_e( 'Quick edit', 'storesuite' ); ?></strong>

					<div class="storesuite-inline-edit-field-row">
						<label class="storesuite-inline-edit-label" for="storesuite-qe-title-<?php echo esc_attr( (string) $product_id ); ?>"><?php esc_html_e( 'Title', 'storesuite' ); ?></label>
						<div class="storesuite-inline-edit-control">
					...
					<label class="storesuite-inline-edit-label storesuite-inline-edit-label-block" for="storesuite-qe-cat-<?php echo esc_attr( (string) $product_id ); ?>"><?php esc_html_e( 'Select Category', 'storesuite' ); ?></label>
					...
					<label class="storesuite-inline-edit-label storesuite-inline-edit-label-block" for="storesuite-qe-tags-<?php echo esc_attr( (string) $product_id ); ?>"><?php esc_html_e( 'Tags', 'storesuite' ); ?></label>
					...
					<label class="storesuite-inline-edit-checkbox">
					...
					<div class="storesuite-inline-edit-field-row">
						<label class="storesuite-inline-edit-label" for="storesuite-qe-status-<?php echo esc_attr( (string) $product_id ); ?>"><?php esc_html_e( 'Status', 'storesuite' ); ?></label>
						<div class="storesuite-inline-edit-control">
				...
				<div class="storesuite-inline-edit-column">
					<strong class="storesuite-inline-edit-section-title"><?php esc_html_e( 'Product data', 'storesuite' ); ?></strong>

					<?php if ( $inline_options['is_sku_enabled'] ) : ?>
						<div class="storesuite-inline-edit-field-row">
							<label class="storesuite-inline-edit-label"><?php esc_html_e( 'SKU', 'woocommerce' ); ?></label>
							<div class="storesuite-inline-edit-control">
					...
					<?php if ( $show_prices ) : ?>
						<div class="storesuite-inline-edit-field-row">
							<label class="storesuite-inline-edit-label"><?php esc_html_e( 'Price', 'woocommerce' ); ?></label>
							<div class="storesuite-inline-edit-control">
						...
						<div class="storesuite-inline-edit-field-row">
							<label class="storesuite-inline-edit-label"><?php esc_html_e( 'Sale', 'woocommerce' ); ?></label>
							<div class="storesuite-inline-edit-control">
					...
					<?php if ( $inline_options['is_weight_enabled'] ) : ?>
						<div class="storesuite-inline-edit-field-row">
							<label class="storesuite-inline-edit-label"><?php esc_html_e( 'Weight', 'woocommerce' ); ?></label>
							<div class="storesuite-inline-edit-control">
					...
					<?php if ( $inline_options['is_dimensions_enabled'] ) : ?>
						<div class="storesuite-inline-edit-field-row storesuite-inline-dimensions-row">
							<label class="storesuite-inline-edit-label"><?php esc_html_e( 'L/W/H', 'woocommerce' ); ?></label>
							<div class="storesuite-inline-edit-control storesuite-inline-dimensions-inputs">
					...
					<?php if ( $show_shipping_class ) : ?>
						<div class="storesuite-inline-edit-field-row">
							<label class="storesuite-inline-edit-label"><?php esc_html_e( 'Shipping class', 'woocommerce' ); ?></label>
							<div class="storesuite-inline-edit-control">
					...
					<div class="storesuite-inline-edit-field-row">
						<label class="storesuite-inline-edit-label"><?php esc_html_e( 'Visibility', 'woocommerce' ); ?></label>
						<div class="storesuite-inline-edit-control">
					...
					<hr class="storesuite-inline-edit-hr">
					...
					<?php if ( ( ProductType::SIMPLE === $ptype || ProductType::VARIABLE === $ptype ) && $inline_options['can_manage_stock'] ) : ?>
						...
						<div class="storesuite-inline-edit-field-row storesuite-stock-qty-row<?php echo $manage_stock ? '' : ' storesuite-hide'; ?>" data-field-toggle="manage_stock" data-field-show-on="true">
							<label class="storesuite-inline-edit-label"><?php esc_html_e( 'Stock quantity', 'storesuite' ); ?></label>
							<div class="storesuite-inline-edit-control">
						...
						<div class="storesuite-inline-edit-field-row storesuite-stock-status-row<?php echo $manage_stock ? ' storesuite-hide' : ''; ?>" data-field-toggle="manage_stock" data-field-show-on="false">
							<label class="storesuite-inline-edit-label"><?php esc_html_e( 'In stock?', 'woocommerce' ); ?></label>
							<div class="storesuite-inline-edit-control">
						...
						<div class="storesuite-inline-edit-field-row storesuite-backorder-row<?php echo $manage_stock ? '' : ' storesuite-hide'; ?>" data-field-toggle="manage_stock" data-field-show-on="true">
							<label class="storesuite-inline-edit-label"><?php esc_html_e( 'Backorders?', 'woocommerce' ); ?></label>
							<div class="storesuite-inline-edit-control">
			...
			<div class="storesuite-inline-edit-actions">
				<button type="button" class="my-storesuite-button storesuite-button-neutral-panel storesuite-inline-edit-cancel"><?php esc_html_e( 'Cancel', 'storesuite' ); ?></button>
				<div class="storesuite-inline-edit-update-wrap">
					<button type="button" class="my-storesuite-button storesuite-inline-edit-update"><?php esc_html_e( 'Update', 'storesuite' ); ?></button>
				</div>
			</div>
