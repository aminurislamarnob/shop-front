...
export const indicators = applyFilters( 'storesuite_analytics_overview_indicators', [
	{
	...
	},
	{
		...
		isReverseTrend: false,
		endpoint:       'variations',
		linkedReport:   'variations',
	},
] );

export const filters = [];
export const advancedFilters = { filters: {}, title: '' };
