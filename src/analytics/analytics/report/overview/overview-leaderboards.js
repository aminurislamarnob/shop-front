...
const LEADERBOARD_ROWS_KEY    = 'storesuite_analytics_leaderboard_rows';
...
export default function OverviewLeaderboards( { query } ) {
	...
	return (
		<Fragment>
			...
			{ visibleLeaderboards.length > 0 ? (
				<div className="storesuite-overview-leaderboards-grid">
...
OverviewLeaderboards.propTypes = {
