...
const SETTINGS_PATH = '/storesuite/v1/settings';
	...
	const saveSettings = useCallback(
		async ( data, customMessage ) => {
			...
			try {
				...
				createSuccessNotice(
					customMessage ??
						__( 'Settings saved successfully!', 'storesuite' ),
					{
						type: 'snackbar',
						id: 'storesuite-save-success',
						isDismissible: false,
						icon: (
							<CheckBadgeIcon
								style={ {
