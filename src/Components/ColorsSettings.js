...
const DARK_THEMES = [
	...
	{
		value: 'high-contrast',
		label: __( 'Dark high contrast', 'storesuite' ),
		description: __(
			'Brighter text and stronger borders for maximum legibility.',
			'storesuite'
		),
		colors: {
			textColor: '#f0f6fc',
			titleTextColor: '#ffffff',
			liteTextColor: '#b1bac4',
			iconColor: '#b1bac4',
			sidebarMenuText: '#f0f6fc',
			sidebarBackground: '#0a0c10',
			sidebarActiveText: '#ffffff',
			sidebarBorderColor: '#7d8590',
			borderColor: '#7d8590',
			liteBgColor: '#161b22',
			pageBg: '#010409',
			surfaceBg: '#0a0c10',
